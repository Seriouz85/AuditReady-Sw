  ...
  private static getCategoryData(category: string): CategoryGuidance | null {
    ...
    const categoryMap: Record<string, CategoryGuidance> = {
      ...
      'Governance & Leadership': {
        ...
        foundationContent: `**a) Leadership commitment and accountability**\nInformation security leadership means that top management (CEO, Board of Directors) actively takes responsibility for protecting the organization's information. Think of this as having the "captain of the ship" personally ensuring the security of all digital assets. This includes establishing an Information Security Management System (ISMS) - which is essentially a systematic approach to managing sensitive company information so that it remains secure. Leadership must demonstrate their commitment through documented policies, regular reviews (at least quarterly), and personal accountability. They need to allocate adequate resources (typically 5-8% of IT budget) and set clear performance indicators to measure success. When leadership is truly committed, security becomes part of the company culture rather than just an IT responsibility.\n\n**b) Scope and boundaries**\nDefining scope means clearly documenting what parts of your organization the security program covers. Imagine drawing a boundary around everything that needs protection - this includes physical locations (offices, data centers), digital boundaries (networks, systems), business processes, and data flows. The scope statement should be like a map that shows exactly what's included and what's excluded, with clear justifications for exclusions. This document needs to be publicly available within the organization and reviewed whenever there are significant changes like acquisitions, new services, or major system changes. Think of it as defining the "security perimeter" - everything inside needs protection according to your security standards.\n\n**c) Organizational structure and security roles**\nThis involves creating a clear organizational chart that shows who is responsible for what aspects of information security. Key roles include: Information Security Officer (the person responsible for day-to-day security operations), Data Protection Officer (required for GDPR compliance - think of this as the "privacy champion"), Incident Response Manager (the person who leads the response when security incidents occur), Risk Owners (business managers responsible for specific risks), and Asset Owners (people responsible for specific systems or data). Each role needs written job descriptions with clear responsibilities, authorities, and reporting relationships. It's like having a well-organized team where everyone knows their position and responsibilities.\n\n**d) Policy framework**\nYour information security policy is the cornerstone document that becomes the foundation for all governance activities. This is where management documents their commitment, communicates expectations, and establishes rules for the organization. The policy framework should include specific timelines and requirements such as: disabling unused accounts within 45 days, having incident response plans ready for quick notifications (GDPR requires notifying authorities within 72 hours for data breaches, NIS2 requires early warning within 24 hours for significant incidents), keeping audit logs for at least 90 days, and patching vulnerabilities monthly. Think of policies as the "rules of the road" for information security - they tell everyone what they must do, should do, and cannot do.\n\n**e) Project management and security integration**\nSecurity must be built into all projects from the very beginning, not added as an afterthought. This means project managers must include security considerations in project planning, conduct security reviews at key milestones (like design review, development completion, testing), and ensure security testing happens before any system goes live. Every project should complete a security impact assessment to understand what security controls are needed. Think of this as ensuring that security is "baked in" to everything the organization builds or buys, rather than being "bolted on" later.\n\n**f) Asset use and disposal policies**\nThink of this like creating rules for how employees can use company equipment and what happens when equipment reaches end of life. Just like you have policies for using company cars or returning keys when someone leaves, you need policies for information assets. This covers what employees can and cannot do with company data, systems, and devices, plus secure procedures for disposing of equipment and returning assets when people leave or when systems are retired. It's about ensuring that company information doesn't accidentally walk out the door or get thrown in the regular trash where others could find it.\n\n**g) Documented procedures and evidence**\nThis is like maintaining a comprehensive filing system that shows you're following all your security rules and can prove it to auditors. Every security process needs step-by-step written procedures, and you need to keep records showing the procedures are actually being followed. This includes evidence of risk assessments, incident reports, training records, management decisions, and compliance activities. Think of it as creating a paper trail that demonstrates your organization takes security seriously and follows through on commitments.\n\n**h) Personnel security framework and leadership responsibilities**\nThis involves having proper HR procedures that address security from the moment someone is hired until they leave the company. Employment terms need to clearly define security responsibilities, employees sign confidentiality agreements, and there are proper procedures for when people change roles or leave. Think of it as ensuring that all the "people aspects" of security are properly managed - from background checks to exit interviews, everyone understands their security obligations.\n\n**i) Competence management**\nThis means making sure that people in security-related roles have the right skills and knowledge to do their jobs properly. Just like you wouldn't want an unqualified person performing surgery, you need to ensure security personnel have appropriate training, experience, and certifications. This includes defining what competencies are needed for each role, providing training to fill gaps, regularly assessing whether people still have the right skills, and keeping records of training and certifications. It's about building and maintaining a competent security workforce.\n\n**j) Monitoring and reporting**\nThink of this as having a regular "health check" system for your security program. Just like you get annual medical checkups, your security program needs regular internal audits, management reviews, and continuous monitoring to make sure everything is working properly. This includes conducting internal security audits at least annually, having management review security status at least quarterly, and maintaining ongoing monitoring of security systems and processes. All findings, decisions, and corrective actions must be documented and reported to management.\n\n**k) Change management and control**\nThis is like having a formal process for making modifications to your house - you don't just start tearing down walls without planning, permits, and oversight. All changes to information systems must follow documented procedures that include security impact assessments, testing, and proper approvals. This prevents changes from accidentally creating security vulnerabilities and ensures that all modifications are properly planned, tested, and documented. It's about maintaining security even when systems are being modified or updated.\n\n**l) External relationships and reporting**\nThis covers your organization's formal relationships with external authorities and partners regarding security matters. Just like you need to know how to contact emergency services, you need established procedures for working with regulatory authorities, law enforcement, and industry partners on security issues. This includes knowing how and when to report security incidents to authorities (like GDPR breach notifications or NIS2 incident warnings), maintaining current contact information, and having templates ready for required communications.\n\n**m) Incident response governance**\nThis involves having clear leadership structure and decision-making processes for when security incidents occur. Think of it like having a designated fire warden and evacuation procedures - you need to know who's in charge during an emergency. This includes designating incident response managers (plus backups), maintaining 24/7 contact information, and defining what constitutes different types of incidents so you know when to escalate or notify authorities. It's about ensuring clear command and control during security crises.\n\n**n) Third-party governance**\nThis means extending your security standards to vendors, contractors, and business partners. Just like you'd have rules for contractors working in your home, you need security requirements in all contracts with external organizations that handle your data or provide services. All service provider contracts must include security clauses, incident notification requirements, audit rights, and proper data handling procedures. You need to actively monitor these relationships and conduct regular security reviews of important vendors.\n\n**o) Continuous improvement**\nThis involves having formal processes to learn from experience and constantly improve your security program. Think of it like how sports teams review game footage to improve their performance - you need systematic processes for learning from security incidents, updating policies based on new threats, addressing audit findings promptly, and tracking security metrics to show improvement over time. It's about ensuring your security program evolves and gets better, not just maintains the status quo.\n\n**p) Security awareness training governance**\nThis is the governance-level oversight of your organization's security awareness training program. While detailed training requirements are covered in other categories, this addresses the strategic and management aspects: defining training strategy, allocating adequate resources, ensuring management commitment, and measuring program effectiveness. Think of it like being the school principal who ensures there's a good education program - you're not teaching the classes, but you're making sure the overall program is properly funded, managed, and achieving its goals.\n\n🎯 OPERATIONAL EXCELLENCE INDICATORS\n\nYour Compliance Scorecard - Track these metrics to demonstrate audit readiness\n\n✅ FOUNDATIONAL CONTROLS\n\n✅ **Policy Documentation** - Comprehensive policies covering all requirement areas with management approval and annual reviews\n✅ **Process Implementation** - Documented and implemented procedures for all security processes with version control\n✅ **Resource Allocation** - Adequate resources assigned to implementation with budget tracking and year-over-year analysis\n✅ **Training Programs** - Staff training on relevant requirements with completion tracking and effectiveness measurement\n\n✅ ADVANCED CONTROLS\n\n✅ **Continuous Monitoring** - Automated monitoring where applicable with real-time dashboards and alerting\n✅ **Regular Reviews** - Periodic assessment and improvement with quarterly management reviews and annual internal audits\n✅ **Integration** - Integration with other business processes including project management and change control\n✅ **Metrics and KPIs** - Measurable performance indicators tied to business objectives and executive accountability\n\n✅ AUDIT-READY DOCUMENTATION\n\n✅ **Evidence Collection** - Systematic evidence gathering with centralized repository and retention policies\n✅ **Compliance Records** - Complete audit trails with timestamped logs and version-controlled documentation\n✅ **Gap Analysis** - Regular assessment against requirements with remediation tracking and progress reporting\n✅ **Corrective Actions** - Documented remediation activities with ownership, timelines, and effectiveness validation\n\n💡 PRO TIP: Phase implementation over 6-12 months: Start with foundational controls (leadership commitment, policies, organizational structure), then advance to sophisticated monitoring and continuous improvement processes. Key success metrics include >95% policy compliance, executive participation in quarterly security reviews, documented incident response exercises, and evidence of year-over-year security program maturation. Use governance frameworks like ISO 27001 or NIST CSF to structure your approach and ensure comprehensive coverage of all requirements.`,
        implementationSteps: [
      ...
      'Risk Management': {
        ...
        foundationContent: `**a) Risk assessment and understanding threats**\nRisk assessment is like conducting a security survey of your home - you walk around looking for potential vulnerabilities (unlocked windows, poor lighting, valuable items visible from outside) and thinking about what bad things could happen and how likely they are. In information security, this means systematically identifying what could go wrong with your technology and data, how likely it is to happen, and what the impact would be on your business.\n\n What this means in practice: Your team creates a simple matrix that evaluates risks on a scale from 1-5 for both likelihood and impact. For example, "employee laptop stolen" might be a 3 for likelihood (happens sometimes) and a 4 for impact (confidential data exposed), making it a high priority risk. You document this process and update it regularly, typically annually for the whole organization and whenever you make major changes.\n\n Why this matters: You can't protect against everything, and trying to would bankrupt your organization. Risk assessment helps you focus your limited time and money on the most important threats. It's like deciding whether to install an expensive alarm system or just better locks - you need to understand what's most likely to happen and what would hurt you most.\n\n**b) Asset identification and valuation**\nThis is like creating a complete inventory of everything valuable in your organization - not just the obvious things like computers and data, but also your reputation, customer trust, and business processes. You need to know what you're protecting before you can decide how much to spend protecting it.\n\n What this means in practice: Your organization creates a comprehensive list of all information assets including servers, databases, customer records, employee files, financial systems, and intellectual property. For each asset, you determine how critical it is to business operations and what it would cost to replace or recreate. You also identify what systems depend on each other, so you understand that if the email server goes down, it might also affect customer support.\n\n Why this matters: Most organizations are surprised by what they actually have and where their real vulnerabilities lie. You might discover that a small database that nobody thought about actually contains critical customer information, or that your backup system depends on the same network as your primary system. It's like mapping your house before a renovation - you need to know what's there before you can plan improvements.\n\n**c) Threat and vulnerability identification**\nThink of this as staying informed about what bad things are happening to organizations like yours, and regularly checking your own defenses for weaknesses. It's like reading neighborhood crime reports and checking your locks and windows regularly.\n\n What this means in practice: Your security team monitors threat intelligence sources to understand what attacks are targeting organizations in your industry. They also run regular vulnerability scans (automated security checks) on your systems to find potential weaknesses like missing security updates or misconfigurations. This information helps you understand both external threats (hackers, malware) and internal vulnerabilities (outdated software, weak passwords).\n\n Why this matters: The threat landscape changes constantly - new attack methods emerge, and your systems change over time potentially creating new vulnerabilities. Regular monitoring helps you stay ahead of threats rather than reacting after something bad happens. It's like having both a neighborhood watch and regular maintenance checks on your home security system.\n\n**d) Risk analysis and prioritization**\nOnce you know what could go wrong, you need to figure out which risks deserve your attention first. This is like triaging problems in an emergency room - treat the life-threatening issues first, then work your way down to less critical problems.\n\n What this means in practice: For each identified risk, you calculate a risk score by multiplying the likelihood of it happening by the potential impact. You then compare all risks against your organization's risk tolerance (how much risk leadership is willing to accept). High-scoring risks that exceed your tolerance levels get prioritized for immediate action. You track key risk indicators like failed login attempts or patch compliance rates to spot developing problems early.\n\n Why this matters: Organizations have limited resources, and everything seems urgent when you're trying to secure complex systems. Risk analysis helps you make rational decisions about where to spend your time and money first. It prevents you from spending enormous effort on unlikely problems while ignoring obvious vulnerabilities.\n\n**e) Risk treatment and mitigation planning**\nOnce you've identified and prioritized your risks, you need to decide what to do about them. You have four basic options: fix the problem (mitigate), avoid the risky activity altogether, transfer the risk to someone else (like insurance), or accept the risk if it's within your tolerance levels.\n\n What this means in practice: For a high-priority risk like "email system vulnerable to cyber attack," you might mitigate by implementing email security software, avoid by moving to a cloud-based email service, transfer by buying cyber insurance, or accept if the cost of protection exceeds the potential loss. Each treatment plan includes specific actions, responsible people, timelines, and success measures.\n\n Why this matters: Identifying risks without acting on them doesn't improve security. Having a systematic approach to risk treatment ensures that important risks get addressed in a timely manner with appropriate resources and oversight.\n\n**f) Risk monitoring and continuous improvement**\nSecurity risks constantly evolve, so your risk management program needs to keep pace. This is like regularly servicing your car - routine maintenance helps prevent breakdowns and extends the life of the vehicle.\n\n What this means in practice: Your organization establishes regular review cycles to reassess risks, monitor the effectiveness of implemented controls, and identify new threats. Key risk indicators are monitored continuously to spot trends and trigger early warnings. Risk assessments are updated whenever there are significant changes to the business, technology, or threat environment.\n\n Why this matters: A risk assessment that sits on a shelf becomes obsolete quickly. Regular monitoring ensures your risk management efforts remain relevant and effective. It also provides valuable data for improving your risk management process over time and demonstrating compliance with various regulatory requirements.`,
        implementationSteps: [
