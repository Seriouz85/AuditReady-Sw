...
interface SocialLoginButtonsProps {
  ...
  onGoogleLogin: () => void;
  onMicrosoftLoginStart: () => void;
  onMicrosoftLoginError: (error: string) => void;
  theme?: string;
}
    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <EntraIdLoginButton
          ...
          disabled={isLoading}
          onLoginStart={onMicrosoftLoginStart}
          onLoginError={onMicrosoftLoginError}
          className="w-full"
        />
      </div>
    </>
